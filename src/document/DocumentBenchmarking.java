...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			String MainString = getStringFromFile(textfile, numToCheck);
			long StartTime = System.nanoTime();
			for (int i = 0; i < 20; i++)
			{
				BasicDocument bd = new BasicDocument(MainString);
				bd.getFleschScore();
			}
			...
			for (int i = 0; i < 20; i++)
			{
				EfficientDocument ed = new EfficientDocument(MainString);
				ed.getFleschScore();
			}
